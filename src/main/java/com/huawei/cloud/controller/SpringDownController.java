...
@RequestMapping
@Controller
public class SpringDownController {
    ...
    public String downloadTxt(@RequestParam String txtname){ 
        ...
        logger.info(ctxPath);
        String downLoadPath = ctxPath + txtname;
        logger.debug("====================下载的路径:============================"+downLoadPath);
        ...
        try{
            ...
            response.setHeader("Content-disposition", "attachment; filename=" + new String(txtname.getBytes("utf-8"), "ISO8859-1"));
